...
public class mishaboomitem extends Item {
    public mishaboomitem(Properties properties) { super(properties);}
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        if (!p_43142_.isClientSide) {
            mishaboomprojectile misha = new mishaboomprojectile(p_43142_, p_43143_);
            misha.setItem(itemstack);
            misha.shootFromRotation(p_43143_, p_43143_.getXRot(), p_43143_.getYRot(), 0.0F, 1.5F, 1.0F);
            p_43142_.addFreshEntity(misha);
        }
